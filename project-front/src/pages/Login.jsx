            ...
            <div className="login__container d-flex justify-content-between">
              ...
              <div className="login__form">
                ...
                <Form onSubmit={handleClick}>
                  ...
                  <TextField type={showPassword ? "text" : "password"} style={{ backgroundColor: "white" }} id="password" placeholder="Enter Your password" variant="standard" required onChange={handleChange} className='form-control' />
                  <span style={{ position: "absolute", right: "10px", top: "50%", transform: "translateY(-50%)", cursor: "pointer" }} onClick={handleShowpassword}>{showPassword ? <BsEyeFill /> : <BsFillEyeSlashFill />}</span>
